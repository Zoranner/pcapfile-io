...
impl PcapFormatProcessor {
    ...
    /// 序列化数据包头
    pub fn serialize_packet_header(
    ...
    pub fn parse_packet(
        ...
        let header =
            Self::parse_packet_header(header_data)?;
    ...
    pub fn validate_file_format(
        ...
        let header = Self::parse_file_header(
            &data[..PcapFileHeader::HEADER_SIZE],
        )?;
